...
public class GradientMenu extends Menu {
	...
	public GradientMenu() {
		...
		gradientChatButton = new ButtonMenu(new PreDefinedGradientMenu.PreDefinedChatGradientsMenu(this),
				ItemCreator.of(Settings.Gradient_Color_Menu_Items.CHAT_ITEM,
						Localization.Gradient_Color_Selection.CHAT_MENU_TITLE,
						Localization.Gradient_Color_Selection.CHAT_MENU_LORE));

		gradientNameButton = new ButtonMenu(new PreDefinedGradientMenu.PreDefinedNameGradientsMenu(this),
				ItemCreator.of(Settings.Gradient_Color_Menu_Items.NAME_ITEM,
						Localization.Gradient_Color_Selection.NAME_MENU_TITLE,
						Localization.Gradient_Color_Selection.NAME_MENU_LORE));

		fillButton = Button.makeDummy(ItemCreator.of(Settings.Gradient_Color_Menu_Items.FILL_ITEM, " ", ""));
	}
